        ...
        <div class="widget-content nopadding">
          ...
          <form action="edit-member-req.php" method="POST" class="form-horizontal">
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <input type="text" class="span11" required name="username" value='<?php echo $row['username']; ?>' />
              </div>
            </div>
            <div class="control-group">
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <input type="text" class="span11" required name="gender" value='<?php echo $row['gender']; ?>' />
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">D.O.R :</label>
              <div class="controls">
                <input type="date" name="dor" required class="span11" value='<?php echo $row['dor']; ?>' />
        ...
        <div class="widget-content nopadding">
          <div class="form-horizontal">
            <div class="control-group">
              ...
              <div class="controls">
                <input type="number" id="mask-phone" name="contact" value='<?php echo $row['contact']; ?>' required class="span8 mask text">
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <input type="text" class="span11" required name="address" value='<?php echo $row['address']; ?>' />
              </div>
            </div>
          </div>
        ...
        <div class="widget-content nopadding">
          <div class="form-horizontal">
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <label>
                  <input type="radio" value="Fitness" required name="services" />
                  Fitness</label>
                <label>
                  <input type="radio" value="Sauna" required name="services" />
                  Sauna</label>
                <label>
                  <input type="radio" value="Cardio" required name="services" />
                  Cardio</label>
              </div>
            </div>
