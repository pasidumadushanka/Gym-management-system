            ...
            <div class="row-fluid">
              <div class="span4">
                <table class="">
                  <tbody>
                    ...
                    <tr>
                      <td>10/A, Galle Road, Colombo 04</td>
                    </tr>
                    
                    <tr>
                      <td>Tel: 011 - 223 4578</td>
                    </tr>
                    <tr>
              ...
              <div class="span8">
                <table class="table table-bordered table-invoice-full">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td><div class="text-center"><?php echo 'LKR.'.$row['amount']; ?></div></td>
                ...
                <table class="table table-bordered table-invoice-full">
                  <tbody>
                    <tr>
                      <td class="msg-invoice" width="55%"> <div class="text-center"><h4>Last Payment Done:  LKR<?php echo $row['amount']; ?>/-</h4>
