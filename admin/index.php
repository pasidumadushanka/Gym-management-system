  ...
  <div class="container-fluid">
    <div class="quick-actions_homepage">
      <ul class="quick-actions">
        ...
        <li class="bg_lg span3"> <a href="payment.php" style="font-size: 16px;"> <i class="fa fa-dollar-sign"></i> Total Earnings: LKR.<?php include'income-count.php' ?></a> </li>
...
<!--Chart-box-->    
    <div class="row-fluid">
          ...
          <div class="row-fluid">
            ...
            <div class="span4">
              <ul class="site-stats">
                ...
                <li class="bg_ly"><i class="fas fa-file-invoice-dollar"></i> <strong>LKR.<?php include 'actions/total-exp.php';?></strong> <small>Total Expenses</small></li>
      ...
      </div><!-- ICBT HD GROUP PROJECT NO 6 -->
...
<!--End-Chart-box--> <!-- ICBT HD GROUP PROJECT NO 6 -->
    <!-- <hr/> -->
    <div class="row-fluid">
      <div class="span6">
        <div class="widget-box">
...
<script src="../js/excanvas.min.js"></script> <!-- ICBT HD GROUP PROJECT NO 6 -->
