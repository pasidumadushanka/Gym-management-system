        ...
        <div class="widget-content nopadding">
          <div class="form-horizontal">
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <input type="text" required class="span11" name="address" value='<?php echo $row['address']; ?>' />
              </div>
            </div>
          </div>
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <label>
                  ...
                  Fitness <small>- LKR5500 per month</small></label>
                <label>
                  <input type="radio" value="Sauna" name="services"  required/>
                  Sauna <small>- LKR3500 per month</small></label>
                <label>
                  <input type="radio" value="Cardio" name="services"  required/>
                  Cardio <small>- LKR4000 per month</small></label>
              </div>
            </div>
