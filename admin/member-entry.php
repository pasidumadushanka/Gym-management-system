...
<!--Header-part--><!-- ICBT HD GROUP PROJECT NO 6 -->
<div id="header">
    ...
    <div class="span6">
      <div class="widget-box">
        ...
        <div class="widget-content nopadding">
          <form action="add-member-req.php" method="POST" class="form-horizontal" onsubmit="return validateForm()">
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <input type="password"  class="span11" name="password" placeholder="**********" required minlength="6" />
        ...
        <div class="widget-content nopadding">
          <div class="form-horizontal">
            <div class="control-group">
              ...
              <div class="controls">
                <input type="number" id="mask-phone" name="contact" placeholder="0777777777" class="span8 mask text" required pattern="[0-9]{10}">
              ...
              <div class="control-group">
                ...
                <div class="controls">
                  <div class="input-append">
                    ...
                    <input type="number" placeholder="5500" name="amount" class="span11" required min="1000">
                  </div>
                </div>
              </div>
